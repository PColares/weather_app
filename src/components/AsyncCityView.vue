<template>
  <div class="flex flex-col flex-1 items-center">
    ...
    >
      <p>
        No momento, você está visualizando esta cidade, clique no ícone "+" para
        começar a rastrear esta cidade.
      </p>
    </div>
    <!-- Weather Overview -->
...
const getWeatherData = async () => {
  try {
    const weatherData = await axios.get(
      `https://api.openweathermap.org/data/3.0/onecall?lat=${route.query.lat}&lon=${route.query.lng}&exclude={part}&appid=a16dbbff4d15995f4c254e6b9c173878&units=metric&lang=pt_br`
    );
